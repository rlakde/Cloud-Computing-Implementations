...
float c = 1.01,d=1.01,e=1.11,f=1.10;
float jj = 1.01,kk=1.01,ll=1.11,mm=1.10;
float cc = 1.01,dd=1.01,ee=1.11,ff=1.10;
float aj = 1.01,ak=1.01,al=1.11,am=1.10;
float ac = 1.01,ad=1.01,ae=1.11,af=1.10;
float ajj = 1.01,akk=1.01,all=1.11,amm=1.10;
float acc = 1.01,add=1.01,aee=1.11,aff=1.10;

#define MAX_THREAD 8 

//limit equals to 15625000000 as 8 operations in each loop
